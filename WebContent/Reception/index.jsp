...
<body>
<%if((session.getAttribute("role").toString().compareTo("4")!=0)&&(session.getAttribute("uid")!=null)){out.print("Invalid Entry : Security Breach");}
else{
 %>
<div id="container">
		...
		<div id="contentContainer">
				...
				<div id="content">
					...
					<img src="../images/bannerreception.png"/>					
								</div>
								<!--Full width ends-->
